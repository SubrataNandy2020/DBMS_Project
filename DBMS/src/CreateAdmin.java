...
public class CreateAdmin extends JFrame {
	...
	public CreateAdmin() {
		...
		btnNewButton.setBounds(202, 398, 89, 23);
		contentPane.add(btnNewButton);
		
		lblTotalNoOf = new JLabel("TOTAL NO. OF EMPLOYEES IN THE COMPANY");
		lblTotalNoOf.setFont(new Font("Times New Roman", Font.BOLD, 25));
		lblTotalNoOf.setBounds(61, 21, 568, 27);
		...
		btnBack.setBounds(447, 398, 89, 23);
		contentPane.add(btnBack);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(50, 86, 609, 279);
