...
public class EUpdate extends JFrame {
	...
	public EUpdate() {
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
			        ...
			        String sql = "select name,email,empid,password,sex,bank,aadhar,desg,bldgrp from employee where empid=?";
					...
					while(res.next()) {
					    ...
					    textField_8.setText(res.getString(5));
		...
		btnSubmit.setBounds(118, 369, 89, 23);
		...
		public void actionPerformed(ActionEvent e) {
				...
				String bank=textField_4.getText();
				String aadhar=textField_5.getText();
				String desg=textField_6.getText();
				String bldgrp=textField_7.getText();
				try {
					ods = new OracleDataSource();
					ods.setURL("jdbc:oracle:thin:SNANDY/snandy@localhost:1521/XE");
			        Connection con= ods.getConnection();
			        String sql = "update employee set name=?,dob=?,email=?,password=?,sex=?,bank=?,aadhar=?,desg=?,bldgrp=? where empid=?";
					PreparedStatement ps=con.prepareStatement(sql);
					...
					// TODO Auto-generated catch block
					e1.printStackTrace();
					JOptionPane.showMessageDialog(null, "COMPLETE THE FULL DETAILS");
		...
		btnUpdate.setBounds(298, 369, 89, 23);
